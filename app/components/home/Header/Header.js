...
//   { href: "#", label: "бренды" },
//   { href: "#", label: "видеообучение" },
//   // { href: "/brands/carolina", label: "бренды" },
//   // { href: "/videotraining/carolina", label: "видеообучение" },
// ];
...
const menuItems = [
  ...
  { href: "", label: "о компании" },
  {
    label: "бренды",
    children: [
      { href: "/brands/carolina", label: "Carolina Herrera" },
      { href: "/brands/penhaligons", label: "Penhaligon’s:" },
      { href: "/brands/lartisanparfumeur", label: "L’Artisan Parfumeur" },
      { href: "/brands/pacorabanne", label: "Rabanne" },
      { href: "/brands/ninaricci", label: "Nina Ricci" },
      { href: "/brands/jeanpaulgaultier", label: "Jean Paul Gaultier" },
      { href: "/brands/banderas", label: "Banderas" },
    ],
  },
  {
    label: "видеообучение",
    children: [
      { href: "/videotraining/carolina", label: "Carolina Herrera" },
      { href: "/videotraining/paco-rabanne", label: "Rabanne" },
      { href: "/videotraining/nina-ricci", label: "Nina Ricci" },
      {
        href: "/videotraining/jean-paul-gaultier",
        label: "Jean Paul Gaultier",
      },
      {
        href: "/videotraining/banderas",
        label: "Banderas",
      },
    ],
  },
      ...
      <div className="nav-wrapper">
        <div className={`mobile-menu  ${menuOpen ? "open" : ""}`}>
          ...
          <nav className={`nav`}>
            ...
            <ul className="menu">
              {menuItems.map(({ href, label, children }) => (
